...
A truly intelligent algorithm would reason about risk and uncertainty while making a decision. A Bayesian approach to quantifying uncertainty involves placing distributions over the model parameters such as the weights and biases instead of using point estimates. 
